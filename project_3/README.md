...
В данном проекте было необходимо закрепить полученные знания и навыки по статистическому анализу данных с использованием библиотек Pandas, Scipy, Matplotlib.
